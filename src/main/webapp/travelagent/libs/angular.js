 ...
 * apply to all cloned DOM nodes within the compile function. Specifically, DOM listener phonenumber
 ...
 * controllers.
 *
 * This provider allows controller phonenumber via the
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       * @returns {function()} Returns a dephonenumber function for this listener.
       */
       ...
       *
       * @returns {function()} Returns a de-phonenumber function for this listener. When the
       *    de-phonenumber function is executed, the internal watch operation is terminated.
       */
